<section class="py-20">
    <x-ui.container>
        <div class="rounded-[32px] border border-brand-400/20 bg-gradient-to-r from-brand-400/10 via-white to-brand-500/10 p-8 dark:via-slate-900 md:p-12">
            <div class="grid gap-10 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
                <div>
                    <span class="text-sm font-semibold uppercase tracking-[0.22em] text-brand-600 dark:text-brand-300">CTA final</span>
                    <h2 class="mt-3 text-3xl font-black md:text-5xl">Seu próximo site pode começar hoje</h2>
