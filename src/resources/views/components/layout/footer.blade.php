<footer class="border-t border-slate-200 bg-slate-100 dark:border-white/10 dark:bg-slate-950">
    <div class="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-2 lg:grid-cols-4 lg:px-6">
        <div>
            <div class="text-lg font-black">Portal Web PE</div>
        ...
        <div>
            <h3 class="font-bold">Soluções</h3>
        ...
        <div>
            <h3 class="font-bold">Atendimento</h3>
            <ul class="mt-4 space-y-3 text-sm text-slate-500 dark:text-slate-400">
        ...
        <div>
            <h3 class="font-bold">Institucional</h3>
            <ul class="mt-4 space-y-3 text-sm text-slate-500 dark:text-slate-400">
    ...
    <div class="border-t border-slate-200/70 dark:border-white/10">
        <div
            class="mx-auto flex max-w-7xl flex-col gap-2 px-4 py-4 text-[11px] text-slate-500 dark:text-slate-400 md:flex-row md:items-center md:justify-between md:gap-4 lg:px-6">
