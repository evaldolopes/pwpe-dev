...
<section class="relative overflow-hidden border-b border-slate-200 py-16 md:py-24 dark:border-slate-700 dark:bg-slate-900">
    ...
    <x-ui.container class="relative z-10">
        ...
        <div class="max-w-4xl">
            <h1 class="text-4xl font-black leading-tight md:text-6xl dark:text-white">{{ $title }}</h1>
            @if($subtitle)
            <p class="mt-5 max-w-3xl text-lg leading-8 text-slate-600 dark:text-slate-400">{{ $subtitle }}</p>
            @endif
        </div>
    </x-ui.container>
</section>